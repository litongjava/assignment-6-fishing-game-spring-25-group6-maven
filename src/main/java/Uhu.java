...
/**
 * Uhu class (adult parrotfish). Final stage of Parrotfish cycle Fish changes
 * colors based on sex Females can transform into supermales
 * 
 * @author Mika Evans
 * @since 2/20/25
 */
public class Uhu extends Panuhunuhu {
	...
	/**
	 * Constructor for Uhu with random length. Sets basic properties Initializes
	 * length and sex
	 */
	public Uhu() {
		super("Uhu", "Parrotfish", "Scarus psittacus", UHU_MAX_LENGTH, UHU_MIN_LENGTH, UHU_MIN_LENGTH,
				(UHU_MIN_LENGTH * 2), DIET_ITEMS, "gray", "reddish gray", "none");
	...
	public Uhu(double length) {
		super("Uhu", "Parrotfish", "Scarus psittacus", UHU_MAX_LENGTH, UHU_MIN_LENGTH, length,
				(length * 2), DIET_ITEMS, "gray", "reddish gray", "none");
		if (length >= UHU_MAX_LENGTH || length < UHU_MIN_LENGTH) {
			throw new FishSizeException("Uhu must be between " + UHU_MIN_LENGTH + " and "
	...
	/**
	 * Constructor with length and sex. Includes chance for females to become
	 * supermales
	 * 
	 * @param length The length of this fish
	...
	public Uhu(double length, String sex) {
		super("Uhu", "Parrotfish", "Scarus psittacus", UHU_MAX_LENGTH, UHU_MIN_LENGTH, length,
				(length * 2), DIET_ITEMS, "gray", "reddish gray", sex);
	...
	/**
	 * Changes fish color. males/females: gray body, reddish gray fins supermales:
	 * blue-green body, blue fins
	 * 
	...
	/**
	 * Changes fish's sex. Only females can change sex to supermales Updates colors
	 * with sex change to supermale
	 */
