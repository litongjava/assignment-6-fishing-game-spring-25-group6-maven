...
public class Ohua extends FishableI_a implements ColorChangeable, SexChangeable {
   ...
   */
   ...
   /** Determines if this fish is a legal size to keep.
   * As the 'Ohua has the Fishable I'a methods, it will apply to any other fish.
   ...
   */
   ...
   /** Determines if this fish can be used as bait or not.
   * 'Ohua cannot be used as bait.
   ...
   */
   ...
   /**Determines if this fish type has a fishing season.
   * 'Ohua season is always, open, thus has no seasonal restriction.
   ...
   */
   ...
   /** This returns the maximum amount of 'Ohua you can have at a time.
   * There is no limit to how many 'Ohua that can be kept, so a placeholder value is used.
