...
public class ReelItIn {
   ...
   */
   public static void main(String[] args) {
      ...
      ReelItIn.growFish(lokoi_a);
   
      //now lets open the pond for fishing!
      ReelItIn.lawai_a(lokoi_a);
   ...
   */
   public static void wavePrint(String text) {
      ...
      System.out.println(EQ_SIGN_LINE + EQ_SIGN_LINE + EQ_SIGN_LINE
          + EQ_SIGN_LINE + EQ_SIGN_LINE + EQ_SIGN_LINE);
   ...
   */
   ...
   /**
   * simulate fishing or Lawai'a over the course of 12 months.
   * 2 players take turns to fish
