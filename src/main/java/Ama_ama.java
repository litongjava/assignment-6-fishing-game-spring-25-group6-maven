...
/**
 * Ama'ama class. Third phase of Ama'Ama family
 * 
 * @author Brian Emmons
 * @since 2/22/2025
 */
public class Ama_ama extends Kahaha {
	...
	//global static variables for Ama_ama class
	...
	/**
	 * Constructor for making Ama'ama uses I_a superclass constructor randomly sets
	...
	public Ama_ama(double length) {
		super("'Ama'ama", AMAAMA_MAX_LENGTH, AMAAMA_MIN_LENGTH, length, (length * 2), DIET_ITEMS,
				"silver", "silver", "male or female");
		this.initSex();
	}

	/**
	 * Constructor for making Pua'Ama with a given length and sex. uses I_a
	 ...
	 * @param sex       sex
	 */
	protected Ama_ama(String name, double maxLength, double minLength, double length, double weight,
